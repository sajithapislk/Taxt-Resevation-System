  ...
  return (
                                    ...
                                    <li className="m-0">
                                        <div className="dropdown">
                                            ...
                                            <div className="dropdown-menu dropdown-menu-right"
                                                ...
                                                <a className="dropdown-item" href="ride-with-carrgo.html">Ride with
                                                    Cargo</a>
                                                <a className="dropdown-item" href="ride-with-carrgo-booked.html">Ride with
                                                    Cargo Booked</a>
                                            </div>
                                        </div>
                                    </li>
    ...
    <section className="responsive-menu">
        <div className="rep-header">
            ...
            <a href="#" className="close-menu"><i className="lni lni-close"></i></a>
        </div>
        <div className="navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="header__upper--right flex-column">
                ...
                <a href="sign-up.html" className="button p-3"><i className="far fa-user-astronaut"></i> Drive with
                    us</a>
                <a href="ride-with-carrgo.html" className="button p-3 my-2" ><i className="far fa-taxi"></i> Book a
                    Ride</a>
